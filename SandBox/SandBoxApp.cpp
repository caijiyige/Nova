...
public:
        ...
        : Layer("Example"),m_OrthoCameraControl(1280.0f/960.0f,true)
    {
        ...
        m_SquareVA.reset(NV::VertexArray::Create());
        std::shared_ptr<NV::VertexBuffer> sqareVB;
        sqareVB.reset(NV::VertexBuffer::Create(sqarevertices,sizeof(sqarevertices)));
        ...
        m_SquareVA->AddVertexBuffer(sqareVB);
         ...
         sqareIB.reset(NV::IndexBuffer::Create(sqareindices,sizeof(sqareindices)/sizeof(unsigned int)));
